...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (262,9201,9202,9203)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (262,9201,9202,9203)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1201620,1189596)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1201620,1189596)
  and c.invalid_reason is null
...
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1103314)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1124300,1177480,1150345,1115008,1112807,1126128,1137460,1195492,1136980,1236607,1178663,1153928,1156378,19029393,19029398,19018431,19019620,19099129,19056874,35197873,43009046,19059506,19110711,19098123,1185922,19071933,19071936,19072152,1113648,19069425,1118045,43009024,1146810,36256128,19029327,40799065,19091809,19041220,19042155,1102917,43009072)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1124300,1177480,1150345,1115008,1112807,1126128,1137460,1195492,1136980,1236607,1178663,1153928,1156378,19029393,19029398,19018431,19019620,19099129,19056874,35197873,43009046,19059506,19110711,19098123,1185922,19071933,19071936,19072152,1113648,19069425,1118045,43009024,1146810,36256128,19029327,40799065,19091809,19041220,19042155,1102917,43009072)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1103374,1118084,1189754)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1103374,1118084,1189754)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (9203,9201,262)
...
JOIN #Codesets codesets on ((vo.visit_concept_id = codesets.concept_id and codesets.codeset_id = 21))
) C

WHERE C.visit_start_date >= DATEFROMPARTS(2008, 11, 30)
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,-90,P.START_DATE) AND A.START_DATE <= DATEADD(day,-31,P.START_DATE)
GROUP BY p.person_id, p.event_id
HAVING COUNT(A.TARGET_CONCEPT_ID) = 0
-- End Correlated Criteria
