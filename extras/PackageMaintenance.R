...
OhdsiRTools::checkUsagePackage("NSAID")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/NSAID.pdf")
shell("R CMD Rd2pdf ./ --output=extras/NSAID.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("NSAID")
