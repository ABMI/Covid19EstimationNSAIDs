...
2. In `R`, use the following `devtools` command to install the NSAID package:
...
License
=======
The NSAID package is licensed under Apache License 2.0

Development
===========
NSAID was developed in ATLAS and R Studio.
